  ...
  return (
    <div className='bg-[#F96106] flex justify-center'>
        <div className='max-w-[1400px] w-full'>
            <div className='flex px-5 md:px-20 py-6 justify-between flex-wrap'>
                <div>
                ...
                <div className='flex flex-col'>
                    <h4 className="text-xl font-semibold text-gray-900 mb-2 mt-3 lg:mt-0">Links</h4>
                ...
                <div>
                    <h4 className="text-xl font-semibold text-gray-900 mb-2 mt-3 lg:mt-0">Contact info</h4>
            ...
            <hr />
            <p className='text-center text-gray-600 text-sm py-2 bg-[#F96106]'>Copyright  &copy; 2024 Destiny Future Academy</p>
        </div>
