  ...
  return (
    <div>
      <div className='bg-[image:url(/imgs/banner.png)] bg-cover bg-[#111111a4] bg-blend-darken bg-center py-12'>
        <h1 className='text-center text-gray-200 text-5xl sm:text-6xl font-semibold mb-3'>#AboutUS</h1>
        <p className='text-center text-gray-200 text-[14px] sm:text-lg font-semibold'>Give a man a fish and you feed him for a day; teach a man to fish and you feed him for a lifetime.</p>
      </div>
      <br /><br />
      <div className='flex justify-center'>
        <div className='px-10 md:px-20 lg:px-32 max-w-[1400px] w-full'>
